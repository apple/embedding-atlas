...
<script lang="ts" module>
  ...
  const icons: Record<string, string> = {
    ...
    // A target/recenter glyph, used for "reset 3D camera".
    reset: `M12 2a.75.75 0 0 1 .75.75v1.79a7.75 7.75 0 0 1 6.71 6.71h1.79a.75.75 0 0 1 0 1.5h-1.79a7.75 7.75 0 0 1-6.71 6.71v1.79a.75.75 0 0 1-1.5 0v-1.79a7.75 7.75 0 0 1-6.71-6.71H2.75a.75.75 0 0 1 0-1.5h1.79a7.75 7.75 0 0 1 6.71-6.71V2.75A.75.75 0 0 1 12 2m0 4a6 6 0 1 0 0 12a6 6 0 0 0 0-12m0 3.5a2.5 2.5 0 1 1 0 5a2.5 2.5 0 0 1 0-5`,
    // A funnel glyph, used to surface an active selection filter while its brush
    // outline is hidden (3D mode).
    filter: `M3 5L21 5L14 12L14 20L10 18L10 12Z`,
  };
</script>
